...
def generate_student_data(existing_roll_nos,existing_phones, existing_student_ids,existing_emails):
    #Not using fake.name() because I dont want titles
...
#Wtih using fake library generating random data
    student_data = {
        "Roll no.": generate_unique_value(existing_roll_nos, lambda: random.randint(1, 999)),
        "Name Surname" : name,
        ...
        "Phone": generate_unique_value(existing_phones, fake.msisdn),
